...
export default function HomeScreen() {
  ...
  const getslideimg = [
    { id: 1, title: 'Aloe Vera Power', subtitle: 'Tough on stains, soft on skin', image: require('../../assets/images/SOAP1.png'), bg: ['#00A300', '#76e076'] },
    { id: 2, title: 'Skin Care', subtitle: 'Gentle daily protection', image: require('../../assets/images/SOAP2.png'), bg: ['#0047AB', '#8ECAE6'] },
    { id: 3, title: 'Dishwash Liquid', subtitle: 'Removes grease instantly', image: require('../../assets/images/SOAP3.png'), bg: ['#FFB703', '#FDFFB6'] },
    { id: 4, title: 'Combo Pack', subtitle: 'More value, more clean', image: require('../../assets/images/SOAP4.png'), bg: ['#6366F1', '#C7D2FE'] },
  ] as const;
        ...
        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={{ flex: 1 }}>
          <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 100 }}>
            ...
            <View style={styles.header}>
              ...
              <TouchableOpacity style={styles.notifyBtn} onPress={()=>router.push('./Modules/Module')as any}>
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.catScroll}>
              {bestSellers.map((cat) => (
                <TouchableOpacity
                  ...
                  onPress={() => router.push(`/product/${cat.id}` as any)}
                >
              ...
              {bestSellers.map((item) => (
                ...
                >
                  <View style={styles.imageStage}>
                    <LinearGradient colors={['#F9F9F9', '#F2F2F2']} style={styles.stageGradient} />
                    <View style={styles.topRow}>
                      <View style={styles.minimalBadge}>
                        <Text style={styles.minimalBadgeText}>PURE</Text>
                      </View>
                    </View>
                  ...
                  <View style={styles.detailsArea}>
                    <Text style={styles.brandText}>POWER SOAPS</Text>
